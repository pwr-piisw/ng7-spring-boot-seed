...
image:https://travis-ci.org/pwr-piisw/oasp4js-ng-boot-project-seed.svg?branch=master["Build Status", link="https://travis-ci.org/pwr-piisw/oasp4js-ng-boot-project-seed"]
